...
handlers.favicon = function(data, callback){
    ...
    if(data.method == 'get'){
        helpers.getStaticAsset('favicon.ico', function(err, icoData){
            if(!err && icoData){
                callback(200, icoData, 'favicon')
            } else {
                callback(500);
            }
        });
        ...
        if (trimmedAssetName.length > 0){
            helpers.getStaticAsset(trimmedAssetName, function(err, data){
                if(!err && data){
                    ...
                    // Determine the content type, default to plain
                    ...
                    if (trimmedAssetName.indexOf('.jgp') > -1) {
                        contentType = 'jpg';
                    }
