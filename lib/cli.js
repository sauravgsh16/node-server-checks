...
cli.responders.help = function () {
    ...
    // Show each command, followed by it's explanation, in white and yellow resp
...
cli.horizontalLine = function () {
    ...
    // Put enought dashes to go across the screen
    var line = '';
...
// Create the centered text on the screen
    ...
    if (checkId) {
        _data.read('checks', checkId, function (err, checkData) {
            if (!err && checkData) {
                ...
                // Print the JSON object with color highlighting
...
cli.processInput = function (str) {
    ...
    if (str) {
        // Only the unique strings that identify the different unique questions needs to be server
        var uniqueInputs = [
            'man',
            'help',
            'exit',
        ...
        // Go through possible inputs, emit events when a match is found
